...
let listaModulo_II = [
    Indicadores(indicador: "Indicador Tasa Bruta Escolarizada", items: ["Total":"", "Mujeres":"", "Hombres":""], codigo: "1.1.4" ,ficha: "1.1.4, G001 F 1.1, U006 F 1.1, U080 F 1.1 - Tasa bruta de escolarización de educación superior.", path: "tasa-bruta-escolarizada"),
    Indicadores(indicador: "Indicador Tasa Bruta Escolarizada (Cobertura) por Entidad Federativa", items: ["Total":"", "Mujeres":"", "Hombres":""], codigo: "1.1.4, G001 F 1.1, U006 F 1.1, U080 F 1.1 ", ficha: "1.1.4, G001 F 1.1, U006 F 1.1, U080 F 1.1 - Tasa bruta de escolarización de educación superior.", path: "tasa-bruta-escolarizada-cobertura"),
...
let listaModulo_III = [
    ...
    Indicadores(indicador: "U080", items: ["Recursos asignados":""], codigo: "U080 1.1",ficha: "U080 1.1 - Programa presupuestal U080", path: "u080"),
