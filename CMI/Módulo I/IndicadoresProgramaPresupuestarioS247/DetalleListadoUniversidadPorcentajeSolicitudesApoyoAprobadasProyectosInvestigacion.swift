...
struct DetalleListadoUniversidadPorcentajeSolicitudesApoyoAprobadasProyectosInvestigacion: View {
                                ...
                                VStack(alignment: .leading,spacing: 10){
                                    HStack{
                                        ScrollView(.horizontal, showsIndicators: true){
                                            !(mouloViewModel.graficasPorcentajeSolicitudesApoyoAprobadasProyectosInvestigacionUniversidad[0].isEmpty) ? Image(uiImage: UIImage(data: (Data(base64Encoded: mouloViewModel.graficasPorcentajeSolicitudesApoyoAprobadasProyectosInvestigacionUniversidad[0])!))!) :  Image(uiImage: UIImage(data: (Data(base64Encoded: imagenDefault)!))!)
                                        }
                                    }.padding(.bottom)
                                }
                            }.padding()
