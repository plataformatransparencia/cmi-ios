...
struct ListadoSubsistemaPorcentajeApoyosIESIncorporacion: View {
    ...
    var body: some View {
        ScrollView(.vertical, showsIndicators: true){
            if mouloViewModel.isTrue{
                ...
                if mouloViewModel.porcentajeApoyosIESIncorporacionSubsistema.isEmpty{
                    Alert()
                    
                }else{
                    ForEach(mouloViewModel.porcentajeApoyosIESIncorporacionSubsistema, id:\.subsistema) { n in
                        NavigationLink(destination: DetalleListadoSubsistemaPorcentajeApoyosIESIncorporacion(titulo: n.subsistema, totalOtorgado: n.totalOtorgado, totalSolicitado: n.totalSolicitado, totalPorcentaje: n.totalPorcentaje, token: token, path: "\(path)/subsistema", periodo: periodo, entidadFederativa: entidadFederativa, subsistema: n.subsistema, universidad: universidad), label: {
