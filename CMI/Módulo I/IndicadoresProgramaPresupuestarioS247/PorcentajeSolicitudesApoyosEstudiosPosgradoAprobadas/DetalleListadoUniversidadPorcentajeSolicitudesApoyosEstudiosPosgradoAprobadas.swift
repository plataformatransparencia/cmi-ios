...
struct DetalleListadoUniversidadPorcentajeSolicitudesApoyosEstudiosPosgradoAprobadas: View {
                                ...
                                VStack(alignment: .leading,spacing: 10){
                                    HStack{
                                        ScrollView(.horizontal, showsIndicators: true){
                                            !(mouloViewModel.graficasPorcentajeSolicitudesApoyosEstudiosPosgradoAprobadasUniversidad[0].isEmpty) ? Image(uiImage: UIImage(data: (Data(base64Encoded: mouloViewModel.graficasPorcentajeSolicitudesApoyosEstudiosPosgradoAprobadasUniversidad[0])!))!) :  Image(uiImage: UIImage(data: (Data(base64Encoded: imagenDefault)!))!)
                                        }
                                    }.padding(.bottom)
                                }
                            }.padding()
