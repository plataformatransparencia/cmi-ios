...
struct ListadoUniversidadPorcentajeSolicitudesApoyosEstudiosPosgradoAprobadas: View {
    ...
    var body: some View {
        ScrollView(.vertical, showsIndicators: true){
            if mouloViewModel.isTrue{
                ...
                if mouloViewModel.porcentajeSolicitudesApoyosEstudiosPosgradoAprobadasUniversidad.isEmpty{
                    Alert()
                    
                }else{
                    ForEach(mouloViewModel.porcentajeSolicitudesApoyosEstudiosPosgradoAprobadasUniversidad, id:\.universidad.nombre) { n in
                        NavigationLink(destination: DetalleListadoUniversidadPorcentajeSolicitudesApoyosEstudiosPosgradoAprobadas(titulo: n.universidad.nombre, items: items, otorgado: n.otorgado, solicitado: n.solicitado, porcentaje: n.porcentaje, token: token, path: path, periodo: periodo, entidadFederativa: entidadFederativa, subsistema: subsistema, universidad: n.universidad.nombre,fuentes: fichaViewModel.fuentesModII), label: {
