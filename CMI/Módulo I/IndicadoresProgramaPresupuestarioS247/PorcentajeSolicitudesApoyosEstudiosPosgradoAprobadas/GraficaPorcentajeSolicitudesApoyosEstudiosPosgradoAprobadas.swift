...
struct GraficaPorcentajeSolicitudesApoyosEstudiosPosgradoAprobadas: View {
    ...
    var body: some View {
        ScrollView(.vertical, showsIndicators: true){
            if mouloViewModel.isTrue{
                ...
                ForEach(mouloViewModel.unionPorcentajeSolicitudesApoyosEstudiosPosgradoAprobadas, id:\.self) { grafica in
                    HStack{
